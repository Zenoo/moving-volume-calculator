...
class MovingVolumeCalculator{ //eslint-disable-line no-unused-vars
    ...
    _build(){
		...
		Object.entries(this._resources).forEach(([room, icon]) => {
     ...
     */
    _predictSurface(){
		this._surfaceInput.value = Math.round(this.volume * (1 / 0.45) * 100) / 100;
	}
